    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAutoMapper(AppDomain.CurrentDomain.GetAssemblies()
                .Where(x =>
                    x.FullName != null && (x.FullName.Equals("LnuCampaign.BLL, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null") ||
                                           x.FullName.Equals("LnuCampaign, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"))));
